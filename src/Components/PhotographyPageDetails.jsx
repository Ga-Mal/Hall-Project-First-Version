            ...
            <div className="w-[90%] mx-auto">
                ...
                <div className="m-10 md:flex flex-wrap justify-center gap-5">
                    {photography.gallery_imgs && photography.gallery_imgs.map((image,i) => (
                        <img loading="lazy" src={image} key={i} alt="img" className="md:w-[48%] max-h-[90vh] mb-5" />
                    ))}
                </div>
                <div className="">
                    <div className="">
                        ...
                        <p className="pb-5 text-(--color-text-black) text-[20px]"><span className="font-semibold ml-7">المحافظة</span> {photography.zone}</p>
                    ...
                    <div className="w-full text-center"> <Link to={"reservation"} className="w-[50%] mx-auto! py-3! text-2xl block custom-button">حجز </Link> </div>
                </div>
            </div>
    </div>
    )
